        ...
        if (isOpen && !defaultProjectId) {
            const fetchProjects = async () => {
                ...
                try {
                    ...
                    console.error("Failed to fetch projects for task modal:", error);
                } finally {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
            ...
            <div className="relative bg-white dark:bg-[#0a0a0a] rounded-2xl w-full max-w-md shadow-xl border border-zinc-200 dark:border-white/10 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="overflow-y-auto p-6 flex-1">
                    <form id="create-task-form" onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-zinc-900 dark:text-white">Task Title</label>
                            <input
                                type="text"
                                value={title}
                        ...
                        {!defaultProjectId && (
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-zinc-900 dark:text-white">Project (Optional)</label>
                                <select
                                    value={projectId}
                ...
                <div className="p-6 border-t border-zinc-200 dark:border-white/10 shrink-0 flex justify-end gap-3 bg-zinc-50/50 dark:bg-[#0a0a0a]/50">
                    ...
                    <Button type="submit" form="create-task-form" disabled={isSubmitting} className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-md">
